...
const Hire = () => {
  return (
    <article className="z-70 bg-yellow-400 hidden cursor-pointer w-[20.2vw] fixed_div md:fixed top-5 right-5 border md:flex flex-col justify-center gap-5 border-gray-300 rounded-md px-3">
