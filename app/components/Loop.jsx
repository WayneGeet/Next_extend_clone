...
const Loop = () => {
  return (
    <div className="border border-gray-300 rounded-md relative overflow-hidden lg:mx-auto lg:pb-10 ">
        ...
        relative lg:-right-20 lg:left-full lg:-translate-x-full overflow-hidden lg:top-5 h_loop mb-16 md:left-0 md:right-0">
            ...
            <div className="py-[5px] col-span-2 row-span-3 overflow-hidden pl-4 border-l border-b border-gray-300">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-start gap-2 ">
                    <div className="flex flex-col gap-[2px] justify-start relative top-10 ">
                        ...
                        <div className="bg-gray-100 text-center px-7 py-2 w-40 lg:w-full border border-gray-200 rounded-sm">
                            <Image src="/sign_red.png" width={20} height={20} alt="signature" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-[2px] justify-start relative top-10">
                        <small className="text=[0.5rem]">on file</small>
                        <div className="bg-gray-100 text-center w-40 lg:w-full px-7 py-2 border border-gray-300 rounded-sm">
                            <Image src="/sign_black.png" width={20} height={20} alt="signb" />
                        </div>
                    </div>
                </div>
