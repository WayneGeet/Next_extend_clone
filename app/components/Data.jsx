        ...
        <div className="flex items-center justify-center h-[76%] py-10">
            ...
            flex items-center justify-center">
                ...
                justify-center items-center relative">
                    <Image className="w-16 " src="/logo.png" width={20} height={20} alt="logo" />
                    <Image className="absolute p-2 bg-white right-0 top-1/2 w-10 h-10 translate-x-1/2 -translate-y-1/2" src="/gallery.png" width={20} height={20} alt="" />
                    <Image className="absolute p-2 bg-white left-0 top-1/2 w-10 h-10 -translate-x-1/2 -translate-y-1/2" src="/pen.png" width={20} height={20} alt="" />
                    <Image className="absolute p-2 bg-white left-1/2 top-0  w-10 h-10 -translate-x-1/2 -translate-y-1/2" src="/csv.png" width={20} height={20} alt="" />
                    <Image className="absolute p-2 bg-white left-1/2 bottom-0 w-10 -translate-x-1/2 h-10 translate-y-1/2" src="/pdf.png" width={20} height={20} alt="" />
                </div>
            </div>
        </div>
